...
export default function SignupPage() {
    ...
    return (
        <div className="min-h-screen bg-[#F8FAFC] flex items-center justify-center p-6 relative overflow-hidden pt-20">
            ...
            <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-[#3525cd] opacity-10 rounded-full blur-[100px] pointer-events-none"></div>
            ...
            <div className="glass-card fade-in w-full max-w-md p-10 md:p-12 relative z-10 rounded-[32px] shadow-2xl border border-white/50 bg-white/60 backdrop-blur-xl">
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-3xl font-black mb-2 text-[#111c2d]">Create Account</h1>
                    <p className="text-[#464555] text-sm font-medium">Start your interview preparation journey</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                    <div>
                        ...
                        <div className="relative group">
                            <FiUser size={18} className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 group-focus-within:text-[#3525cd] transition-colors" />
                            <input 
                                type="text" 
                    ...
                    <button 
                        type="submit" 
                        className="mt-4 w-full py-4 rounded-xl font-bold text-white bg-[#3525cd] hover:bg-[#281a9c] transition-all shadow-lg shadow-[#3525cd]/30 hover:-translate-y-0.5 hover:shadow-xl flex items-center justify-center gap-2 disabled:opacity-70 disabled:hover:translate-y-0 disabled:shadow-none"
                        disabled={loading}
                    >
                        {loading ? (
                ...
                <p className="text-center mt-8 text-sm font-medium text-[#464555]">
                    ...
                    <Link href="/login" className="text-[#3525cd] font-bold hover:underline">Sign In</Link>
                </p>
            </div>
        </div>
    );
